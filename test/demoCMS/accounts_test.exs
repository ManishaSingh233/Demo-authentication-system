defmodule DemoCMS.AccountsTest do
  use DemoCMS.DataCase

  alias DemoCMS.Accounts

  describe "users" do
    alias DemoCMS.Accounts.User

    import DemoCMS.AccountsFixtures
  ...
  describe "credentials" do
    alias DemoCMS.Accounts.Credential
